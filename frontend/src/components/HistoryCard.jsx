...
const HistoryCard = (props) => {
    ...
    return (
        ...
        <div id="accordion-collapse" className='my-5' data-accordion="collapse">
            ...
            <div id="accordion-collapse-body-3" class={`${!opened && "hidden" }`} aria-labelledby="accordion-collapse-heading-3">
